...
const addOne = (arr) => {
  ...
  const localArray = [];
  arr.forEach(element => {
    const newNum = element + 1;
    localArray.push(newNum);
  });
  return localArray;
};
...
const addExclamation = (arr) => {
  ...
  const localArray = [];
  arr.forEach(element => {
    const newExclamation = `${element}!`;
    localArray.push(newExclamation);
  })
  return localArray;
};
...
const allUpperCase = (arr) => {
  ...
  const localArray = [];
  arr.forEach(element => {
    const newCase = element.toUpperCase();
    localArray.push(newCase);
  })
  return localArray;
};
...
const speaker = (words, callback) => {
  ...
  words.forEach(element => {
    const stringNew = callback(element);
    localArray.push(stringNew);
  })
  return localArray;
};
...
const fizzbuzz = (arr) => {
  ...
  arr.forEach(element => {
    // console.log(element);
    const div3Test = element % 3;
    const div5Test = element % 5;
    if (div5Test === 0 && div3Test === 0) {
